...
class FollowingFragments: Fragment(R.layout.fragment_user_foll) {

    private var _binding : FragmentUserFollBinding? = null
    private val binding get() = _binding!!
    private lateinit var viewModel: FollowingModelViews
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        showLoading(true)
        viewModel = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(FollowingModelViews::class.java)
